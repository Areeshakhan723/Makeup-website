...
const HandFeetCard = ({ imgURL, name, description, price }: Card) => {
  return (
    <>
      <div className="p-0 m-0 overflow-hidden">
        <div>
          <Image
            ...
            width={300}
            height={230}
            className="relative object-cover bg-white sm:w-[300px] h-[230px] mt-16 m-0 p-0 transform transition duration-300 ease-in-out hover:scale-110"
          />
        </div>
        ...
        <div className="flex mt-2 flex-row md:flex-col lg:flex-col xl:flex-col md:px-0.5">
