  ...
  return (
    <div className="bg-white w-auto max-w-[700px] padding">
      ...
      <div className="mt-5 flex justify-center items-center px-2 py-2">
        <button
          onClick={handleEvent}
          className="w-full flex justify-center items-center px-2 py-3 text-deco border border-transparent bg-primaryPink mt-2 ml-2 md:ml-0 transition duration-300 hover:scale-110 hover:text-white"
        >
          Submit your payment
        </button>
      </div>
