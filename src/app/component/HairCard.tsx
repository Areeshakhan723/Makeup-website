...
const HairCard = ({ imgURL, name, description, price }: Card) => {
  return (
    <>
      <div className="p-0 m-0 overflow-hidden">
        <div>
          <Image
            ...
            width={300}
            height={230}
            className="relative bg-white object-cover sm:w-[300px] h-[230px] mt-16 m-0 p-0 transform transition duration-300 ease-in-out hover:scale-110"
          />
        </div>
